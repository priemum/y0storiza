...
client.createMessage(msg.channel.id, {
  "embed": 
    {
      "title": "Bc Bot , Help list [ My Perfix Now Is [prefix] ]".replace('[prefix]', prefix),
      "color": 26282,
      "fields": [
        {
          "name": "General",
          "value": "`[prefix]ping`".split("[prefix]").join(prefix)
        },
        {
          "name": "Moderator",
          "value": "`[prefix]info`, `[prefix]bc`".split("[prefix]").join(prefix)
        },
        {
          "name": "Premium",
